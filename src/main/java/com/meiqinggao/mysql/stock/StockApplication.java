...
//		}
		...
		if (response.getData().getItems().size() > 0){
			parseJsonFile(allStockCodes, response, dateDate);
		}
...
//		stockConceptRepository.saveAll(stocks);
	...
	public void parseJsonFile(List<String> codes, Response response, Date date) throws FileNotFoundException, UnsupportedEncodingException {
